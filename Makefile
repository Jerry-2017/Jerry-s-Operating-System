...
GAME_OBJECT := ./game/game.o ./src/device/timer.o ./src/device/keyboard.o ./src/device/int.o ./src/device/com.o ./src/common/printk.o ./src/common/mystring.o ./src/device/svga.o ./src/sys/display.o ./src/sys/syscall.o ./src/common/rvgs.o ./src/common/rngs.o 
